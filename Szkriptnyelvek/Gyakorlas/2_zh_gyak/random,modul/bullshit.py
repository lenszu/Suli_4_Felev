...
def get_bullshit():
    ...
    elso = ["Erõforrás-alapú megközelítéssel kell",
    ...
    harmadik = ["a közösségi normáknak megfelelõ",
                "a decentralizált",
    ...
    return elso[random.randint(1, len(elso))]+" "+masodik[random.randint(1, len(masodik))]+" "+harmadik[random.randint(1, len(harmadik))]+" "+negyedik[random.randint(1, len(negyedik))]+"."
